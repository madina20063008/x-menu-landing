          ...
          <div className="relative order-first lg:order-none">
            <div className="relative z-10">
              <div className="relative mx-auto max-w-xs sm:max-w-sm">
                <div className="bg-white rounded-[2.5rem] sm:rounded-[3rem] shadow-2xl p-3 sm:p-4 border-8 border-gray-800">
                  <div className="bg-gray-900 h-5 sm:h-6 rounded-t-3xl mb-2" />
                  <img
              ...
              <div
                className="hidden sm:block absolute -right-6 bottom-24 bg-white rounded-2xl shadow-xl p-3 sm:p-4 border border-gray-200 animate-float"
